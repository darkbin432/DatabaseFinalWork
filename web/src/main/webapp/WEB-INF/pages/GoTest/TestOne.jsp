...
<head>
    ...
    <title id="examTitle">计算机174_175_作业14(文件)</title>
    <script>
        var sitePath = '/';
    </script>
    ...
    <div id="content" style="padding: 10px 0 0 10px; margin-right: 200px; background-color: #fff;">
        <div id="content_left" style="float: left; width: 150px; padding: 15px 10px; border-right: 1px solid #eee; overflow: auto;">
            <dl class="bundle-item front">
                ...
                <dd data-val-id="2445923" class="finish">
                    <a href="javascript:;" data-val-id="2445923">第1题</a>
                </dd>
                <dd data-val-id="2445924" class="finish">
                    <a href="javascript:;" data-val-id="2445924">第2题</a>
                </dd>
                <dd data-val-id="2445925" class="finish">
                    <a href="javascript:;" data-val-id="2445925">第3题</a>
                </dd>
                <dd data-val-id="2445926" class="finish">
                    <a href="javascript:;" data-val-id="2445926">第4题</a>
                </dd>
                <dd data-val-id="2445927" class="finish">
                    <a href="javascript:;" data-val-id="2445927">第5题</a>
                </dd>
                <dd data-val-id="2445928" class="finish">
                    <a href="javascript:;" data-val-id="2445928">第6题</a>
                </dd>
                <dd data-val-id="2445929" class="finish">
                    <a href="javascript:;" data-val-id="2445929">第7题</a>
                </dd>
                <dd data-val-id="2445930" class="finish">
                    <a href="javascript:;" data-val-id="2445930">第8题</a>
                </dd>
                <dd data-val-id="2445931" class="finish">
                    <a href="javascript:;" data-val-id="2445931">第9题</a>
                </dd>
                <dd data-val-id="2445932" class="finish">
                    <a href="javascript:;" data-val-id="2445932">第10题</a>
                </dd>
                <dd data-val-id="2445933" class="finish">
                    <a href="javascript:;" data-val-id="2445933">第11题</a>
                </dd>
                <dd data-val-id="2445934" class="finish">
                    <a href="javascript:;" data-val-id="2445934">第12题</a>
                </dd>
                <dd data-val-id="2445935" class="finish">
                    <a href="javascript:;" data-val-id="2445935">第13题</a>
                </dd>
                <dd data-val-id="2445936" class="finish">
                    <a href="javascript:;" data-val-id="2445936">第14题</a>
                </dd>
                <dd data-val-id="2445937" class="finish">
                    <a href="javascript:;" data-val-id="2445937">第15题</a>
                </dd>
                <dd data-val-id="2445938" class="finish">
                    <a href="javascript:;" data-val-id="2445938">第16题</a>
                </dd>
                <dd data-val-id="2445939" class="finish">
                    <a href="javascript:;" data-val-id="2445939">第17题</a>
                </dd>
                <dd data-val-id="2445940" class="finish">
                    <a href="javascript:;" data-val-id="2445940">第18题</a>
                </dd>
                <dd data-val-id="2445941" class="finish">
                    <a href="javascript:;" data-val-id="2445941">第19题</a>
                </dd>
                <dd data-val-id="2445942" class="finish">
                    <a href="javascript:;" data-val-id="2445942">第20题</a>
                </dd>

            </dl>
        </div>
        <div id="content_right" style="margin-left: 171px;">
            <div id="question_toolbar" class="clearfix" style="border-bottom: 1px solid #ccc; height: 30px; line-height: 30px; padding-top: 6px;">
                <div class="icon-menu">
                    <a href="javascript:;" class="icon-delete" id="cmd_redo"><span>重做</span></a>
                </div>
                <div class="icon-menu-separator">
                </div>
                <div class="icon-menu">
                    <a href="javascript:;" class="icon-previous" id="cmd_previous"><span>上一题</span></a>
                </div>
                <div class="icon-menu icon-right">
                    <a href="javascript:;" class="icon-next" id="cmd_next"><span>下一题</span></a>
                </div>
                <div class="clearfix">
                </div>
            </div>
            <div id="question_content" class="layout-relative" style="margin-top: 0; overflow-y: auto;">
                ...
                <div id="c-grid-ajax">
                    <div class="question-item" id="2445923" data-type="SINGLE_CHIOCE" data-type-judgeonsave="0">
                        ...
                        <div class="question-face"><p>打开文件c:\scores.txt进行读操作，使用（&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ）。</p></div>
                        <div class="question-answer">
                            <input class="question-option-input" type="radio" value="A" id="Question_2445923_OptionA" name="ANSWER_2445923">
                            <label for="Question_2445923_OptionA">
                                A. infile = open("c:\scores.txt", "r")</label><br>
                            <input class="question-option-input" checked="'checked'" type="radio" value="B" id="Question_2445923_OptionB" name="ANSWER_2445923">
                            <label for="Question_2445923_OptionB">
                                B. infile =open("c:\\scores.txt", "r")</label><br>
                            <input class="question-option-input" type="radio" value="C" id="Question_2445923_OptionC" name="ANSWER_2445923">
                            <label for="Question_2445923_OptionC">
                                C. infile =open(file = "c:\scores.txt", "r")</label><br>
                            <input class="question-option-input" type="radio" value="D" id="Question_2445923_OptionD" name="ANSWER_2445923">
                            <label for="Question_2445923_OptionD">
                                D. infile =open(file = "c:\\scores.txt", "r")</label><br>
                        </div>
